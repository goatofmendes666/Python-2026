...
f = 2.5
g = complex(8 + 2)
print("The type of d is", type(d)) # Boolean data type
print("The type of e is", type(e)) # NoneType data type
print("The type of f is", type(f)) # Float data type
print("The type of g is", type(g)) # Complex Data Type

# Special --> Sequence Data Types
list1 = [1,5,3,8,4,6,9], [2,2.5,-5], ["apple", "banana", "qiwi", "mango", "orange"]
print(list1) # List Data Type
tuple1 = ((2,2.5,-4),("Apple", "banana", "mango", "orange"))
print(tuple1) # tuple data Type
dict1 = {"Name":"Garv", "Age": 20, "Bio": "Handsome"}
print(dict1) # Dictionary Data Type
